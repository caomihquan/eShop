...
namespace Eshop.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public  List<ProductVm> GetProductID(string languageId, int id)
        {
            var DB = new LoadData();
            var tbl =  DB.LoadDataSQL("Exec getProductID {0},{1}",languageId,id);
            List<ProductVm> listName = tbl.AsEnumerable().Take(3).Select(m => new ProductVm()
            {
                Id = m.Field<int>("Id"),
